 ...
 * 
 * VIEW LAYER COMPONENT: UI screen rendering interface for MVC View layer
 * ============================================================================
 */

#ifndef ISCREEN_RENDERER_H
#define ISCREEN_RENDERER_H
...
public:
     ...
     * 
     * @return Screen name (e.g., "MenuScreen", "GameOverScreen")
     */
    virtual const char* getName() const = 0;
};

#endif // ISCREEN_RENDERER_H
