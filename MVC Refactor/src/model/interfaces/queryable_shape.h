...
public:
     ...
     *   - Different shape instances of same type return same ID
     * 
     * @return Type identifier (0-6 for standard Tetris pieces)
     */
    virtual int getTypeId() const = 0;
    
    /**
     * Get human-readable name of this shape (for debugging)
     * 
     * PRECONDITIONS:
     *   - Object is properly initialized
     * 
