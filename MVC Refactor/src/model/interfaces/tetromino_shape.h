 ...
 * 
 * MODEL LAYER COMPONENT: Pure data + color queries, no rendering, no input
 * ============================================================================
 */
...
public:
    ...
    // Inherited from IQueryableShape - subclasses must implement
    virtual const int* getShapeMatrix() const = 0;
    virtual int getTypeId() const = 0;
    virtual const char* getName() const = 0;
    
    // Inherited from IColoredShape - subclasses must implement
